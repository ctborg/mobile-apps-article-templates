    ...
    window.logOnScreen = function(log) 
        {
            if (!window.loggingPanel)
            {
                ...
                window.loggingPanel.setAttribute("style", "font-size:1.5rem;position:fixed;bottom:0;background-color:rgba(0,0,0,0.7);height:20%;width:100%;z-index:30;color:orange;overflow-y:scroll;padding:3px;");
